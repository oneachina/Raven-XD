//package cn.onea.keystrokesmod.utility;
//
...
//    }
//
//    public boolean overVoid(int posX, double posY, int posZ) {
//        for (int i = (int) posY; i > -1; i--) {
//            getBlockState(new BlockPos(posX, i, posZ)).getBlock();
//        }
//        return true;
//    }
//
...
//        if (mc.player != null) {
//            return overVoid((int) mc.player.position().x, mc.player.position().y, (int) mc.player.position().z);
//        }
//    }
//
